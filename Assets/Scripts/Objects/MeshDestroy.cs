...
/// <summary>
/// Modified version of script mesh destruction script made by ditzel <href>https://gist.github.com/ditzel/73f4d1c9028cc3477bb921974f84ed56</href>
/// </summary>
public abstract class MeshDestroy : MonoBehaviour
{
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(MeshDestroy original)
        {
            ...
            var meshDestroy = GameObject.AddComponent<Destructable>();
            meshDestroy.CutCascades = original.CutCascades;
            meshDestroy.ExplodeForce = original.ExplodeForce;

            // Set to ignore collisions with projectiles
            GameObject.layer = 9;
